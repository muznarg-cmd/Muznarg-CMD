...
📚 Interessada em educação, literatura, artes e tecnologia  
💻 Explorando programação e desenvolvimento de ferramentas educacionais  
🎨 Aprendendo modelagem 3D, Blender e criação para Roblox  

## Sobre mim

Sou estudante de Licenciatura em Linguagens e gosto de desenvolver projetos que aproximam educação, criatividade e tecnologia.

Tenho interesse na criação de materiais didáticos, metodologias de aprendizagem ativa, recursos digitais para professores e projetos de design e modelagem 3D.

Este perfil será utilizado para registrar meus estudos, projetos e evolução profissional.
...
- Criação de conteúdos para Roblox
...
Meu objetivo é construir um portfólio que reúna educação, tecnologia, arte e criatividade, mostrando tanto os projetos finalizados quanto meu processo de aprendizagem.
